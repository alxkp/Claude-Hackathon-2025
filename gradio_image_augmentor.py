...
Original file is located at
    https://colab.research.google.com/drive/1SJ-pKigyZ4zxjYlyF7gOr9WH_L4cN8p1
"""
...
api_key = "AIzaSyCpsRFGPrdE1n9EHI29_hIGnubuT83_XuE"
...
def edit_image(image, prompt_text):
    ...
    try:
        ...
        if edited_image:
            ...
            return edited_image, f"✅ Image edited successfully! Size: {width}x{height}"
        elif response_text:
            return None, f"⚠️ No image generated. Response: {response_text}"
        else:
...
def generate_depth_map(image):
    ...
    try:
        if image is None:
            return None, "❌ No image available. Please upload or generate an image first."
        ...
        return depth_map, f"✅ Depth map generated successfully! Size: {width}x{height}"
...
with gr.Blocks(title="Gemini Image Editor + Depth Map", theme=gr.themes.Soft()) as demo:
    gr.Markdown("# 🎨 Gemini Image Editor + 🗺️ Depth Map Generator")
    ...
    with gr.Row():
        with gr.Column(scale=1):
            ...
            prompt_input = gr.Textbox(
                label="✏️ Editing Instructions",
                placeholder="Describe what changes you want to make...",
                lines=4,
                value=example_prompt
            )

            edit_button = gr.Button("✨ Edit Image", variant="primary", size="lg")
        ...
        with gr.Column(scale=1):
            ...
            depth_button = gr.Button("🗺️ Generate Depth Map", variant="secondary", size="lg")

    with gr.Row():
        with gr.Column(scale=1):
            depth_output = gr.Image(
                label="🌡️ Depth Heat Map",
                height=350,
                type="pil",
                interactive=False,
                show_download_button=True
            ...
            depth_status = gr.Textbox(
                label="📊 Depth Map Status",
                lines=2,
                interactive=False
            )

    # Examples section
    gr.Markdown("### 📝 Quick Example Prompts:")
    ...
    gr.Markdown("### 🎯 More Example Prompts:")
    gr.Markdown("""
    - `make the jacket red`
